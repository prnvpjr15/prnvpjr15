...
**IT Student** passionate about **Computer Science & Software Engineering**.
I enjoy building scalable web applications, designing REST APIs, and working across the full stack—from backend services and databases to modern frontend applications—while also exploring how machine learning and computer vision can power intelligent, real-world systems. I'm always looking for opportunities to learn, build impactful projects, and write clean, maintainable code.
